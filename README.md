...
- **📦 Multi-Exportação**: Salve como **WEBP (Ultra leve)**, **PNG (HD)**, **JPG**, **PDF (Pronto para impressão)**, **TIFF** ou **BMP**.
- **🎯 Alpha Matting**: Algoritmo de refinamento de bordas para eliminar halos brancos e serrilhados em logos complexos.
- **🏷️ Salvamento Inteligente**: Modal personalizado para renomear arquivos e funcionalidade de "Visualizar & Imprimir" para PDFs.
...
- **FPDF2**: Geração robusta de documentos PDF.
...
- **macOS**: Otimizado via *Apple M3 Neural Pipeline*.
- **Windows (NVIDIA)**: Ativa *CUDA Enabled (RTX Optimized)*.
...
## 📄 Notas de Versão
- **v3.0**: Adicionada vetorização SVG e suporte a PDFs.
